...
extension Dictionary {
    ...
    public func jsonEncodedSafely(options: JSONSerialization.WritingOptions = .fragmentsAllowed) -> Data? {
    ...
    public func jsonEncoded(options: JSONSerialization.WritingOptions = .fragmentsAllowed) -> Data? {
        return try? JSONSerialization.data(withJSONObject: self, options: options)
    }
}
